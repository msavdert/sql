...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE ('                          task_name   => ''TASK AWR &1''  ,                   ');
  DBMS_OUTPUT.PUT_LINE ('                          description => ''Awr task for &1'');                 ');
  ...
  DBMS_OUTPUT.PUT_LINE (CHR (10));
  DBMS_OUTPUT.PUT_LINE ('EXEC DBMS_SQLTUNE.execute_tuning_task(task_name => ''TASK AWR &1'');          ');
  ...
  DBMS_OUTPUT.PUT_LINE ('select dbms_sqltune.report_tuning_task(''TASK AWR &1'') from dual;            ');
  
  DBMS_OUTPUT.PUT_LINE (CHR (10));                                                                                                  
  DBMS_OUTPUT.PUT_LINE ('================================= DROP TASK  ==================================	');                         
  DBMS_OUTPUT.PUT_LINE (CHR (10));                                                                                                    
  DBMS_OUTPUT.PUT_LINE ('BEGIN                                                                          ');
  DBMS_OUTPUT.PUT_LINE ('DBMS_SQLTUNE.DROP_TUNING_TASK (''TASK AWR &1'');                              ');
  DBMS_OUTPUT.PUT_LINE ('END;                                                                           ');
  DBMS_OUTPUT.PUT_LINE ('/                                                                              ');
